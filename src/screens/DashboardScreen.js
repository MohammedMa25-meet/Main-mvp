    ...
    <SafeAreaView style={containerStyle}>
      {showSidebar && (
        <View style={[styles.sidebar, isDarkMode && styles.sidebarDark]}>
          ...
          <View style={styles.sidebarMenu}>
            ...
            <TouchableOpacity style={styles.menuItem} onPress={() => { setShowSidebar(false); if (onScreenChange) onScreenChange('CareerTracker'); }}>
              <Ionicons name="trending-up" size={20} color="#6B7280" />
              <Text style={[styles.menuText, textStyle]}>{t('Career Tracker')}</Text>
            </TouchableOpacity>
      ...
      <View style={styles.mainContent}>
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          {/* Career Tracker Button */}
          <TouchableOpacity 
            style={[styles.careerTrackerButton, cardStyle]} 
            onPress={() => onScreenChange('CareerTracker')}
          >
            <View style={styles.careerTrackerContent}>
              <View style={styles.careerTrackerIcon}>
                <Ionicons name="trending-up" size={24} color="#ffffff" />
              </View>
              <View style={styles.careerTrackerText}>
                <Text style={[styles.careerTrackerTitle, titleStyle]}>{t('Career Tracker')}</Text>
                <Text style={[styles.careerTrackerSubtitle, textStyle]}>{t('Track your progress and goals')}</Text>
              </View>
